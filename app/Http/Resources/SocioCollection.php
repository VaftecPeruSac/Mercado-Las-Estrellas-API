            ...
            'data' => $this->collection->transform(function ($socio) {
                return [
                    ...
                    'datos_socio' => $socio->usuario->persona ? [
                        'nombre_socio' => $socio->usuario->persona->nombre,
                        ...
                        'telefono' => $socio->usuario->persona->telefono ? $socio->usuario->persona->telefono : 'No',
                        'correo' => $socio->usuario->persona->correo ? $socio->usuario->persona->correo : 'No',
                    ] : 'No',
                    'puesto' => $socio->puesto ? [
